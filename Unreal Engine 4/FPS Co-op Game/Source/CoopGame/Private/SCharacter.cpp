...
ASCharacter::ASCharacter()
{
	...
	//CameraComp->bUsePawnControlRotation = true; // 카메라가 뷰어의 관점에서 정상적으로 회전할 수 있게 하는 것
...
void ASCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &ASCharacter::CrouchToggle);
